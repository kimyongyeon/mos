...
<form name=write method=post action=serial_reg_02_ok.php enctype=multipart/form-data onsubmit="return check_submit();">
<table width="400" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="1" colspan="4"><img src="images/img_21.gif" width="275" height="22" hspace="10" vspace="10" /></td>
	</tr>
	<tr>
