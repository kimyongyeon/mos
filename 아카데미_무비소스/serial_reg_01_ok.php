<?
	...
	if(!eregi("serial_reg_01.php",$HTTP_REFERER)) Error("정상적으로 작성하여 주시기 바랍니다","");
...
// 수강 정보 삽입
	mysql_query("insert into TB_REG1 (CLASS_ID, USER_ID, BOOK_SNO, REG_ILSI, IP, HOST) values ('$p_class_id','$user_id','$p_book_sno','$reg_ilsi', '$remote_addr','$remote_host' )");
